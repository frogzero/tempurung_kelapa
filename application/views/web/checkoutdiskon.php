      ...
      <tbody>
        ...
        <?php endforeach; ?>
            ...
            <tfoot>
                ...
                <tr>
                <?php foreach($result_detail_kupon as $num_row=>$row){?>
                <td></td>
                ...
                <?php 
                $diskon=$row->jumlah;
                $totalsebelum=$this->cart->total();
                $total_setelah_diskon=$totalsebelum-$diskon;
                ?>
                ...
                <tr><td></td>
                    ...
                    <td align="right"><?php echo  $total_setelah_diskon;?></td>
                    <input type="text" name="totalpesan" value="<?php echo  $total_setelah_diskon;?>" hidden />
                </tr>
            </tfoot>
        </table>
                <hr>
     ...
     <?php }?> 
       ...
       <div class="row" >
          ...
          <div class="form-group col-md-6">
            ...
            <button class="form-group btn btn-success col-md-12" type="submit" onclick="myFunction()">Simpan</button> <br><br>
